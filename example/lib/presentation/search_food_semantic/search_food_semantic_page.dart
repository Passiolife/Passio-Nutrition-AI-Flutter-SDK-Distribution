...
import 'package:nutrition_ai_example/presentation/search_food_semantic/bloc/search_food_semantic_bloc.dart';
...
class SearchFoodSemanticPage extends StatefulWidget {
  const SearchFoodSemanticPage({super.key});

  @override
  State<SearchFoodSemanticPage> createState() => _SearchFoodSemanticPageState();
}

class _SearchFoodSemanticPageState extends State<SearchFoodSemanticPage> {
  ...
  final TextEditingController _searchController = TextEditingController(
      text: 'Show me high-protein recipes that are suitable for dinner.');
  ...
  final _bloc = sl<SearchFoodSemanticBloc>();
