...
part 'search_food_semantic_event.dart';
part 'search_food_semantic_state.dart';

class SearchFoodSemanticBloc
    extends Bloc<SearchFoodSemanticEvent, SearchFoodSemanticState> {
  SearchFoodSemanticBloc() : super(FoodSearchInitial()) {
  ...
  Future<void> _doFoodSearchEvent(
      DoFoodSearchEvent event, Emitter<SearchFoodSemanticState> emit) async {
    ...
    final searchResponse =
        await NutritionAI.instance.searchForFoodSemantic(event.searchQuery);
  ...
  FutureOr<void> _doFetchFoodItemEvent(
      DoFetchFoodItemEvent event, Emitter<SearchFoodSemanticState> emit) async {
  ...
  FutureOr<void> _doSubmitUserFoodEvent(DoSubmitUserFoodEvent event,
      Emitter<SearchFoodSemanticState> emit) async {
  ...
  Future<void> _doReportFoodItem(
      DoReportFoodItem event, Emitter<SearchFoodSemanticState> emit) async {
