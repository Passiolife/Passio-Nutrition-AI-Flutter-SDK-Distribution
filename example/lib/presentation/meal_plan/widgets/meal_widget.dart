          ...
          ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              return _FoodItemRowWidget(
                ...
                subtitle:
                    '${data?.nutritionPreview.servingQuantity.format() ?? ''} ${data?.nutritionPreview.servingUnit.toUpperCaseWord ?? ''} (${data?.nutritionPreview.weightQuantity.format()} ${data?.nutritionPreview.weightUnit}) | ${data?.nutritionPreview.calories ?? 0} ${context.localization?.day.toUpperCaseWord ?? ''}',
