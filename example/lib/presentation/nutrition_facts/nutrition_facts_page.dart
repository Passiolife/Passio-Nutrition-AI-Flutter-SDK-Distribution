      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            _buildNutritionRow('Weight Quantity',
                '${nutritionFacts?.weightQuantity?.toString() ?? 'N/A'} ${nutritionFacts?.weightUnit?.toString() ?? 'N/A'}'),
            _buildNutritionRow('Serving Quantity',
                nutritionFacts?.servingQuantity?.toString() ?? 'N/A'),
            _buildNutritionRow('Serving Unit',
                nutritionFacts?.servingUnit?.toString() ?? 'N/A'),
            _buildNutritionRow(
