...
class PassioIDAttributes {
  ...
  factory PassioIDAttributes.fromJson(Map<String, dynamic> json) =>
      mapToPassioIDAttributes(json);

  Map<String, dynamic> toJson() => mapOfPassioIDAttributes(this);
...
class PassioAlternative {
  ...
  factory PassioAlternative.fromJson(Map<String, dynamic> json) =>
      mapToPassioAlternative(json);

  Map<String, dynamic> toJson() => mapOfPassioAlternative(this);
}
...
class PassioFoodOrigin {
  ...
  factory PassioFoodOrigin.fromJson(Map<String, dynamic> json) =>
      mapToPassioFoodOrigin(json);

  Map<String, dynamic> toJson() => mapOfPassioFoodOrigin(this);
}
